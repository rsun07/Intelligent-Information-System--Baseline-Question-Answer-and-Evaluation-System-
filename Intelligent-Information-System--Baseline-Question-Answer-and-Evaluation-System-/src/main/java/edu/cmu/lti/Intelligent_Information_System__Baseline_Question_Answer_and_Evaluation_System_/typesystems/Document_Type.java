...
public class Document_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Document");
  ...
  public int getRelevanceValue(int addr) {
      ...
      jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Document");
  ...
  public int getQueryID(int addr) {
      ...
      jcas.throwFeatMissing("queryID", "edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Document");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Document");
  ...
  public int getTokenList(int addr) {
      ...
      jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Document");
