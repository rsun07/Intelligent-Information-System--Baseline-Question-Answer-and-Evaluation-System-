...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Token");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Token");
  ...
  public int getFrequency(int addr) {
      ...
      jcas.throwFeatMissing("frequency", "edu.cmu.lti.f14.hw2.Intelligent_Information_System__Baseline_Question_Answer_and_Evaluation_System_.typesystems.Token");
